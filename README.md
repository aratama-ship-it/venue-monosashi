...
- `data/candidate-venues.csv`: 全国の類似会場候補（74施設・47都道府県）
...
2026-07-30時点の監査値は、過去大会225行、JYYF全国大会・前身大会28件、JYYF地区大会106件、ジュニア大会9件、WYYC 28年、AJDC 13件、OIDC 7件、KWC 5件、全日本少年少女けん玉1件、候補74施設、47都道府県、施設区画116件、料金観測311件、時間区分の参考合計13件、運用観測56件、エラー0です。未確認警告1件はWYYC 1999の正確なホノルル会場名で、推測値を入れず空欄にしています。
