globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BElUDgC2.js","assets/layout-segment-context-CSRYyoPr.js","assets/script-s7PEnRqT.js"];
...
function getDraftSecret() {
	return "18237de9-5c0f-4ecb-a573-c09d5efff7d3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "65ede6f9-50b6-474b-87f9-904e7603a4d5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "65ede6f9-50b6-474b-87f9-904e7603a4d5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "65ede6f9-50b6-474b-87f9-904e7603a4d5",
		rootBoundaryId
	});
}
/**
...
//#endregion
//#region app/venue-search.tsx
var VenueSearch = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'VenueSearch' is called on server");
}, "54e7cc413194", "VenueSearch");
//#endregion
//#region app/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(VenueSearch, {});
}
...
var cloudflareAnalyticsToken = process.env.NEXT_PUBLIC_CLOUDFLARE_WEB_ANALYTICS_TOKEN?.trim() || "977721791a104a10ae5b37312104bbf5";
var cloudflareAnalyticsEnabled = /^[0-9a-f]{32}$/i.test(cloudflareAnalyticsToken);
function RootLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("html", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [
			...
			children,
			cloudflareAnalyticsEnabled ? /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(script_default, {
				id: "cloudflare-web-analytics",
				strategy: "afterInteractive",
				type: "module",
				src: "https://static.cloudflareinsights.com/beacon.min.js",
				"data-cf-beacon": JSON.stringify({ token: cloudflareAnalyticsToken.toLowerCase() })
			}) : null
		] })
	});
}
...
var __publicFiles = new Set([
	"/data/small-theater-ledger.b5d4ca3c3b10.json",
	"/data/small-theater-ledger.json",
	"/data/small-theater-research.b5d4ca3c3b10.csv",
	"/data/small-theater-research.csv",
	"/favicon.svg",
	"/file.svg",
	"/globe.svg",
	"/og-card.png",
