globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DiChdinC.js","assets/layout-segment-context-BgFSJhYC.js"];
...
function getDraftSecret() {
	return "db4606c2-cf56-4df8-b50d-6d0adbf666b2";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "240f6ce8-cc28-4709-8094-8006f38f2600";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "240f6ce8-cc28-4709-8094-8006f38f2600") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "240f6ce8-cc28-4709-8094-8006f38f2600",
		rootBoundaryId
	});
}
/**
