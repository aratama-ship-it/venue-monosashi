globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CPfZA03m.js","assets/layout-segment-context-B1WlJcf_.js"];
...
function getDraftSecret() {
	return "33ef6427-1c21-42f0-8b70-eeab5e8078e3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4073cde0-daab-432a-9f64-1fa81f4ebd93";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4073cde0-daab-432a-9f64-1fa81f4ebd93") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4073cde0-daab-432a-9f64-1fa81f4ebd93",
		rootBoundaryId
	});
}
/**
