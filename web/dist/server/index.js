globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-6Q2pr4Bz.js","assets/layout-segment-context-D_iB4_2g.js"];
...
function getDraftSecret() {
	return "29739807-e73c-40f0-bb05-0228d403ad8f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5aacf08c-2c68-4876-a83d-91e064c409df";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5aacf08c-2c68-4876-a83d-91e064c409df") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5aacf08c-2c68-4876-a83d-91e064c409df",
		rootBoundaryId
	});
}
/**
