globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CNUJ3Zlf.js","assets/layout-segment-context-DooZModf.js"];
...
function getDraftSecret() {
	return "e572e33f-9771-4171-b055-adb63de655d5";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "dfd681bc-eb60-4ea2-a2a7-0c3543aeb864";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "dfd681bc-eb60-4ea2-a2a7-0c3543aeb864") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "dfd681bc-eb60-4ea2-a2a7-0c3543aeb864",
		rootBoundaryId
	});
}
/**
