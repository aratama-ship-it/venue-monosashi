globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BKSBac2R.js","assets/layout-segment-context-Drbm49-9.js"];
...
function getDraftSecret() {
	return "c9b0eec7-2777-4189-a5da-76a9b47b3e2f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4c7e78cb-e138-4bed-827e-de32b2fabeed";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4c7e78cb-e138-4bed-827e-de32b2fabeed") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4c7e78cb-e138-4bed-827e-de32b2fabeed",
		rootBoundaryId
	});
}
/**
