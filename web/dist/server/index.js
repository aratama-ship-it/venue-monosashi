...
function getDraftSecret() {
	return "9809b7c4-2523-4d55-9ffe-cc3ed3580b3e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "67e1087f-04c0-4342-b0df-5e6760a954fb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "67e1087f-04c0-4342-b0df-5e6760a954fb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "67e1087f-04c0-4342-b0df-5e6760a954fb",
		rootBoundaryId
	});
}
/**
