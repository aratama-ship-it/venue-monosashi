...
function getDraftSecret() {
	return "2eb2e3f0-96bf-4159-a65c-3dff3ee4be80";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "46e08c1b-2c7d-45ef-908a-808dbccea126";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "46e08c1b-2c7d-45ef-908a-808dbccea126") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "46e08c1b-2c7d-45ef-908a-808dbccea126",
		rootBoundaryId
	});
}
/**
