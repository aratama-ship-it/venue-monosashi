globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-1n2Erdy3.js","assets/layout-segment-context-DT-RPmm4.js"];
...
function getDraftSecret() {
	return "90d354fa-1bea-40c2-add4-9090ea3ca106";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cff9ac80-139b-4af8-a2bb-8bc58ab64133";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cff9ac80-139b-4af8-a2bb-8bc58ab64133") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cff9ac80-139b-4af8-a2bb-8bc58ab64133",
		rootBoundaryId
	});
}
/**
