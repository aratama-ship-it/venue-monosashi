globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DgLyO6pL.js","assets/layout-segment-context-z3ZrZYgO.js"];
...
function getDraftSecret() {
	return "a0918c52-48d7-4d67-9ee9-f6a8fd26e578";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cd4032a0-abb1-4bc5-bc58-c6a957b7b6e8";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cd4032a0-abb1-4bc5-bc58-c6a957b7b6e8") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cd4032a0-abb1-4bc5-bc58-c6a957b7b6e8",
		rootBoundaryId
	});
}
/**
