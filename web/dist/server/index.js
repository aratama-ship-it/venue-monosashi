globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-5Yxgs7PK.js","assets/layout-segment-context-DouIdGXz.js"];
...
function getDraftSecret() {
	return "738e24b6-ece8-4198-9d7b-c71cc457e2d7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "98d18e17-6e13-4281-b5cf-5b8ba67c2f64";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "98d18e17-6e13-4281-b5cf-5b8ba67c2f64") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "98d18e17-6e13-4281-b5cf-5b8ba67c2f64",
		rootBoundaryId
	});
}
/**
