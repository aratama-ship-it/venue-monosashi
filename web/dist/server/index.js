globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DBCozSHP.js","assets/layout-segment-context-BnW40l-V.js"];
...
function getDraftSecret() {
	return "29ce8816-1754-48c2-ba20-5a3beec8355d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9687160b-7183-4b42-99a4-1aafa347f401";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9687160b-7183-4b42-99a4-1aafa347f401") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9687160b-7183-4b42-99a4-1aafa347f401",
		rootBoundaryId
	});
}
/**
