globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BDCagNo1.js","assets/layout-segment-context-Bd_MWbsx.js"];
...
function getDraftSecret() {
	return "d3497aab-ca82-43d6-858c-afee77de44eb";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4e2e563a-cf86-4ec4-9504-cb0bdc16754e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4e2e563a-cf86-4ec4-9504-cb0bdc16754e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4e2e563a-cf86-4ec4-9504-cb0bdc16754e",
		rootBoundaryId
	});
}
/**
