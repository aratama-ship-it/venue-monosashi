globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CIJ5ynnV.js","assets/layout-segment-context-BTkamlNh.js"];
...
function getDraftSecret() {
	return "a83f99ce-50b7-4051-b7cf-c7667da4ec12";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c1a9e9d2-8e87-4cb3-928d-d43d9406d591";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c1a9e9d2-8e87-4cb3-928d-d43d9406d591") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c1a9e9d2-8e87-4cb3-928d-d43d9406d591",
		rootBoundaryId
	});
}
/**
