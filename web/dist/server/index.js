globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CBBC1tP0.js","assets/layout-segment-context-BicgHfCx.js"];
...
function getDraftSecret() {
	return "79afcc71-d4be-4ca1-bacc-7cda06aec8d4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d5b6dab1-90aa-49c9-9d6d-578e55102a76";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d5b6dab1-90aa-49c9-9d6d-578e55102a76") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d5b6dab1-90aa-49c9-9d6d-578e55102a76",
		rootBoundaryId
	});
}
/**
