globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-C2p0J07d.js","assets/layout-segment-context-CV7kgH96.js"];
...
function getDraftSecret() {
	return "458a27ef-ac02-4bd7-8171-8ea2a362743d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "82fd6ba7-b902-4a54-ba33-1e48022926c3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "82fd6ba7-b902-4a54-ba33-1e48022926c3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "82fd6ba7-b902-4a54-ba33-1e48022926c3",
		rootBoundaryId
	});
}
/**
