globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-B5Wq7TyX.js","assets/layout-segment-context-D2BcB3jP.js"];
...
function getDraftSecret() {
	return "7bd6720e-6966-4c30-83ed-0ce8ba249110";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "25e5c0e0-6257-4070-9d61-49538a1c6272";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "25e5c0e0-6257-4070-9d61-49538a1c6272") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "25e5c0e0-6257-4070-9d61-49538a1c6272",
		rootBoundaryId
	});
}
/**
