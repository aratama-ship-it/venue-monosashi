globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DJOVR7q0.js","assets/layout-segment-context-D0hM0tCQ.js"];
...
function getDraftSecret() {
	return "2381c2bc-b574-44a6-b1fa-2748d8c97a61";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "fc8093e2-0b6c-495c-82ed-d09f21f4f7ed";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "fc8093e2-0b6c-495c-82ed-d09f21f4f7ed") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "fc8093e2-0b6c-495c-82ed-d09f21f4f7ed",
		rootBoundaryId
	});
}
/**
