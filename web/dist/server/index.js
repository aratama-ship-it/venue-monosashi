globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CrjzODiD.js","assets/layout-segment-context-vYTmLxCR.js"];
...
function getDraftSecret() {
	return "40861027-d8db-44da-a230-f52a09029b0a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3370675f-c947-4912-97ce-055069767f2b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3370675f-c947-4912-97ce-055069767f2b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3370675f-c947-4912-97ce-055069767f2b",
		rootBoundaryId
	});
}
/**
