globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DXoAdCR-.js","assets/layout-segment-context-DTPNZ516.js","assets/script-s7PEnRqT.js"];
...
function getDraftSecret() {
	return "bf038181-72c1-478d-ba36-8cb5061d0ab8";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5d70f98c-9726-4c34-81bc-44e8359e7920";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5d70f98c-9726-4c34-81bc-44e8359e7920") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5d70f98c-9726-4c34-81bc-44e8359e7920",
		rootBoundaryId
	});
}
/**
