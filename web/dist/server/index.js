globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-ej0y91vl.js","assets/layout-segment-context-B4pdzt8i.js"];
...
function getDraftSecret() {
	return "13fc4bfd-0b05-41ca-a20f-af4568f3b41c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "849d0d07-27f4-4b49-ba44-2590b51f6554";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "849d0d07-27f4-4b49-ba44-2590b51f6554") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "849d0d07-27f4-4b49-ba44-2590b51f6554",
		rootBoundaryId
	});
}
/**
