globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BodvcGy8.js","assets/layout-segment-context-Bh9Y9y_P.js","assets/script-s7PEnRqT.js"];
...
function getDraftSecret() {
	return "0c4f26f0-2d48-4bdd-89f6-c1368d295f90";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "90a0f281-778f-41fe-b5a1-ef927f92b93c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "90a0f281-778f-41fe-b5a1-ef927f92b93c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "90a0f281-778f-41fe-b5a1-ef927f92b93c",
		rootBoundaryId
	});
}
/**
	...
	changelog: [
		{
			date: "2026-08-20",
			title: "小劇場を会場候補へ統合",
			detail: "公式確認済みで現在も運営している小劇場369件を候補データへ入れ、独立していた小劇場台帳を廃止。小劇場タグでの絞り込み、料金の確認状況の表示、条件で絞ったときに未確認のため表に出ない件数の明示を追加。候補は1,838施設。"
		},
		{
			date: "2026-08-05",
			title: "共有・比較・鮮度表示を追加",
