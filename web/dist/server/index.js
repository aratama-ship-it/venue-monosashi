globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BOLEZk0z.js","assets/layout-segment-context-B8xSrEZM.js"];
...
function getDraftSecret() {
	return "b33a92e1-9c55-4613-80b6-8ba399c31fac";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d7749c7b-770e-45b7-90c4-6064f42a4527";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d7749c7b-770e-45b7-90c4-6064f42a4527") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d7749c7b-770e-45b7-90c4-6064f42a4527",
		rootBoundaryId
	});
}
/**
