globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CG0haHpU.js","assets/layout-segment-context-B2POty1B.js"];
...
function getDraftSecret() {
	return "72163d88-9876-4f4d-9f96-c944fc2adb85";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cd693e40-8010-49e6-86e6-533e504070e0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cd693e40-8010-49e6-86e6-533e504070e0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cd693e40-8010-49e6-86e6-533e504070e0",
		rootBoundaryId
	});
}
/**
