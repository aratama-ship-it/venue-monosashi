globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-XpmK7k-T.js","assets/layout-segment-context-DpOePhB4.js"];
...
function getDraftSecret() {
	return "a20efa3c-2012-4568-80df-d7e8b5d551e4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c81c9300-da53-44ef-8da1-46641ea954d3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c81c9300-da53-44ef-8da1-46641ea954d3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c81c9300-da53-44ef-8da1-46641ea954d3",
		rootBoundaryId
	});
}
/**
