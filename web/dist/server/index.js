globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-GEPd378W.js","assets/layout-segment-context-4ezv9JGG.js"];
...
function getDraftSecret() {
	return "9f23712d-a334-4483-9f35-674d22ff2ae5";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "092c43be-e9c4-4df6-8be5-77565a8b82da";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "092c43be-e9c4-4df6-8be5-77565a8b82da") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "092c43be-e9c4-4df6-8be5-77565a8b82da",
		rootBoundaryId
	});
}
/**
