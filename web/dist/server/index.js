globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-Dho5A400.js","assets/layout-segment-context-S_LXxP6P.js"];
...
function getDraftSecret() {
	return "294eb278-3591-4aff-a3ae-cb15750e6f24";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "04538e96-ba0d-4b38-bb22-5c00ab08d59b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "04538e96-ba0d-4b38-bb22-5c00ab08d59b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "04538e96-ba0d-4b38-bb22-5c00ab08d59b",
		rootBoundaryId
	});
}
/**
