globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-kxnppr04.js","assets/layout-segment-context-CwwqczVc.js"];
...
function getDraftSecret() {
	return "43ab60f3-df3d-4018-a45d-bdf464816128";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cf859f82-f605-49dd-8e3f-aef2ec632303";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cf859f82-f605-49dd-8e3f-aef2ec632303") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cf859f82-f605-49dd-8e3f-aef2ec632303",
		rootBoundaryId
	});
}
/**
