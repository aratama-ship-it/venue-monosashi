globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CP0Rznpx.js","assets/layout-segment-context-CmP5kl8b.js"];
...
function getDraftSecret() {
	return "3a6a9160-1875-4ac4-9ff9-1c425a07423e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2784e64d-84cd-4a5a-8175-06b6fc453b9e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2784e64d-84cd-4a5a-8175-06b6fc453b9e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2784e64d-84cd-4a5a-8175-06b6fc453b9e",
		rootBoundaryId
	});
}
/**
