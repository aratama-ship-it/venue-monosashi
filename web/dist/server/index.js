globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-Dtfg1BAU.js","assets/layout-segment-context-SRdky7Qt.js"];
...
function getDraftSecret() {
	return "016cf483-c0b5-4c10-933a-cf75c7680875";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e4838cda-9145-4921-a385-6a6a9d550a6b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e4838cda-9145-4921-a385-6a6a9d550a6b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e4838cda-9145-4921-a385-6a6a9d550a6b",
		rootBoundaryId
	});
}
/**
