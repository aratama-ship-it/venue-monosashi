...
function getDraftSecret() {
	return "af500532-81a7-43f6-840c-468ce039123e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bacbdd21-3c34-4fe5-9ec6-f7b95f313131";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bacbdd21-3c34-4fe5-9ec6-f7b95f313131") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bacbdd21-3c34-4fe5-9ec6-f7b95f313131",
		rootBoundaryId
	});
}
/**
