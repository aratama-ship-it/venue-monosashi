globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-F0zefSKm.js","assets/layout-segment-context-CTxflB-b.js","assets/script-s7PEnRqT.js"];
...
function getDraftSecret() {
	return "ef034a50-a826-4369-85b2-12065173b606";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "389fb105-195f-4bc5-89f1-cc4b3b64df65";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "389fb105-195f-4bc5-89f1-cc4b3b64df65") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "389fb105-195f-4bc5-89f1-cc4b3b64df65",
		rootBoundaryId
	});
}
/**
