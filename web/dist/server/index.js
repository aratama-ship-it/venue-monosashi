globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-BRgs68yj.js","assets/layout-segment-context-CHqr3qp0.js"];
...
function getDraftSecret() {
	return "f99effbb-9471-4d7a-b959-b795f84f177e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "37d76e37-b0d9-4809-b0bb-6ddc19fb4c4d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "37d76e37-b0d9-4809-b0bb-6ddc19fb4c4d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "37d76e37-b0d9-4809-b0bb-6ddc19fb4c4d",
		rootBoundaryId
	});
}
/**
...
var metadata = {
	...
	description: "JJF・ヨーヨー・ディアボロ・けん玉の過去会場を基準に、全国のイベント会場と150席以下の小劇場を規模・天井高・予算・搬入・アクセスで比較する調査版サービス。"
};
