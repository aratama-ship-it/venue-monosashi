globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DhusXLxW.js","assets/layout-segment-context-C7Wnf7W2.js"];
...
function getDraftSecret() {
	return "ac96a6f7-826c-49f8-85ae-4af32b18ff65";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2f94b33c-2e6a-430c-b55e-b876212cd830";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2f94b33c-2e6a-430c-b55e-b876212cd830") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2f94b33c-2e6a-430c-b55e-b876212cd830",
		rootBoundaryId
	});
}
/**
