...
function getDraftSecret() {
	return "ff0535b3-08f9-48ed-ba88-ec571ce36f37";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d73a2817-b014-481e-82cf-1695ce8eaa91";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d73a2817-b014-481e-82cf-1695ce8eaa91") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d73a2817-b014-481e-82cf-1695ce8eaa91",
		rootBoundaryId
	});
}
/**
