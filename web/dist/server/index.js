globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-DQK7p-dl.js","assets/layout-segment-context-WFl2yoR8.js"];
...
function getDraftSecret() {
	return "bd301552-8424-4adf-bcb4-a7d40cbe063e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3d6c5a7c-5b6c-4d1d-8485-05d7d5a75ede";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3d6c5a7c-5b6c-4d1d-8485-05d7d5a75ede") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3d6c5a7c-5b6c-4d1d-8485-05d7d5a75ede",
		rootBoundaryId
	});
}
/**
...
var publication = {
	...
	description: "JJF・ヨーヨー・ディアボロ・けん玉の過去会場を基準に、全国のイベント会場と150席以下の小劇場を規模・天井高・予算・搬入・アクセスで比較する公開調査版。",
