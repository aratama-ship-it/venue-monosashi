globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CnH_985z.js","assets/layout-segment-context-CZZJBlg3.js"];
...
function getDraftSecret() {
	return "cf38c7f3-56e7-44bf-9221-8fd27d7373d0";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "49ae8852-86ac-4ea1-b83c-2e00fc0b92cf";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "49ae8852-86ac-4ea1-b83c-2e00fc0b92cf") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "49ae8852-86ac-4ea1-b83c-2e00fc0b92cf",
		rootBoundaryId
	});
}
/**
