globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-vh0VkcyG.js","assets/layout-segment-context-DZV_oIPf.js"];
...
function getDraftSecret() {
	return "5cf7c340-7bb1-4dd4-b91e-dbf04f5c1c0a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "aa0693d2-85e2-4803-baf3-dc35d912dcdd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "aa0693d2-85e2-4803-baf3-dc35d912dcdd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "aa0693d2-85e2-4803-baf3-dc35d912dcdd",
		rootBoundaryId
	});
}
/**
