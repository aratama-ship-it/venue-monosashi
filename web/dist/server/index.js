globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/venue-search-CCeJU1YX.js","assets/layout-segment-context-C5lmcD1H.js"];
...
function getDraftSecret() {
	return "3d223cb8-c5c6-4537-bb5d-63c5e801ce06";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "efbf705b-799e-4632-899b-2d4f65ae4f00";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "efbf705b-799e-4632-899b-2d4f65ae4f00") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "efbf705b-799e-4632-899b-2d4f65ae4f00",
		rootBoundaryId
	});
}
/**
