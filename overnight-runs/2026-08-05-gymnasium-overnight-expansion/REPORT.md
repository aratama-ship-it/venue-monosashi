...
ACTIVE — wave 148完了。全国47都道府県・候補230件の目標を達成し、2026-08-06 07:00 JSTまで既存候補の深掘りを継続中。
...
- Wave 126: カメイアリーナ仙台の料金版監査で第1競技場12件を訂正し、第2競技場12料金観測を追加（`2929084`）。
- Wave 126では現行施設ページの直リンクPDFが2019年4月作成の旧税率表であることを検出。仙台市公式の使用料改定案内（2025年2月更新）が2019年10月1日適用として案内する指定管理者PDFを全4ページ画像照合し、第1競技場12件を税込現行額へ訂正した。同じ表から第2競技場のアマチュアスポーツ12件を追加。休館・再開後再確認を保持し、lintと表示テスト3件も合格した。
- Wave 127: カメイアリーナ仙台の個人利用・照明19料金観測を追加（`96905d9`）。
...
- Wave 135: トッケイセキュリティ平塚総合体育館の第2武道場16料金観測を追加（`48cc478`）。
- Wave 135では第2武道場の半面/全面、一般・大学生・高校生・中学生以下、市内外を補完。市外2倍、営利/入場料倍率、H31.3更新表と2026年更新ページからの現行リンク関係を保持し、3波ごとのlintと表示テスト3件も合格した。
- Wave 136: トッケイセキュリティ平塚総合体育館の弓道場16料金観測を追加（`c2be2d4`）。
- Wave 136では弓道場の半面/全面、一般・大学生・高校生・中学生以下、市内外を補完。市外2倍、営利/入場料倍率、H31.3更新表と2026年更新ページからの現行リンク関係を保持した。
- Wave 137: トッケイセキュリティ平塚総合体育館の会議・放送・記録18料金観測と3区画を追加（`08c4606`）。
...
- Wave 142: 相好アリーナ四日市の多目的室スポーツ20料金観測を追加（`028def4`）。
- Wave 142では多目的室1の3区画/2区画/1区画、多目的室2の2区画/1区画について、スポーツ・入場料なしの午前/午後/夜間/全日料金を指定管理者の現行HTMLから補完した。
- Wave 143: 相好アリーナ四日市の多目的室スポーツ以外20料金観測を追加（`861f972`）。
- Wave 143では多目的室1の3区画/2区画/1区画、多目的室2の2区画/1区画について、スポーツ以外・入場料なしの午前/午後/夜間/全日料金を指定管理者の現行HTMLから補完した。
- Wave 144: 相好アリーナ四日市の弓道・トレーニング・会議40料金観測を追加（`b7a8fef`）。
...
- Wave 147: 相好アリーナ四日市の支援区画設備46料金観測を追加（`d15dc75`）。
- Wave 147では多目的室1/2に空調と共通器具、弓道場に観覧席空調・音響・家具・電源、トレーニングに音響・家具・電源、大小会議室に区画別空調・大会議室限定の音響映像・共通家具電源を追加。共通料金は適用先の区画ごとに明示し、施設未特定の共用在庫へ逃がさなかった。3波ごとのlintと表示テスト3件も合格した。
- Wave 148: 高岡市竹平記念体育館の4区画・6料金観測を追加し、候補/運用の公式URLを現行ページへ更新（`06e761b`）。
...
- Current local totals: candidates 230 / details 474 / prices 2579 / operations 222.
- Overnight additions from baseline: candidates +47 / details +203 / prices +2189 / operations +120.
