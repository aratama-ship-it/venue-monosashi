...
- Wave 47 local verification passed: app-data generation, `npm run audit`, `npm run depth-report:write`, and `git diff --check` passed with only the pre-existing historical-record warning. Miyazaki is now 15 candidates, 14 municipalities, and 78 spaces; national remaining deficits are 507 candidates and 182 spaces. Public deployment remains to be completed.
