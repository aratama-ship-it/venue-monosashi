...
- Current wave: Wave 34 — Ibaraki official-source expansion (next).

## Baseline

- Git branch and commit: `agent/add-competition-and-small-theater-coverage` at `5c0946bc6e73c553c168f3f8b13468e64790da72`.
- Data counts: 607 candidate facilities, 2,477 searchable spaces, 2,823 price observations, and 222 operation rows.
- Depth target: 25 candidates, 15 municipalities, and 51 spaces per prefecture. Remaining deficits: 568 candidates and 260 spaces; municipality deficit is measured by the generated report.
...
- Research one bounded official-source wave for 茨城県, the next lowest candidate-depth prefecture tied at 11 candidates, then regenerate all reports and deploy after validation.
