...
- Research one bounded official-source wave for the next lowest candidate-depth prefecture from the regenerated report: 鹿児島県 is lowest at 10 candidates; 岩手県、秋田県、山形県、福島県、茨城県、群馬県、埼玉県、千葉県、石川県 follow at 11.
